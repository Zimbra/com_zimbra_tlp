...
function(controller) {    
   ...
   '<br><br><select id="TLPZimletsensitivity"> <option value="[TLP:RED]">'+zimletInstance.getMessage('TLPZimlet_redDescription')+'</option><option value="[TLP:AMBER]">'+zimletInstance.getMessage('TLPZimlet_amberDescription')+'</option><option value="[TLP:GREEN]">'+zimletInstance.getMessage('TLPZimlet_greenDescription')+'</option><option value="[TLP:WHITE]">'+zimletInstance.getMessage('TLPZimlet_whiteDescription')+'</option></select></div>'
   );
...
function(controller) {
   ...
   {
      case "[TLP:RED]":
         appCtxt.getCurrentView()._subjectField.value = "[TLP:RED] " + subject;
         break;
      case "[TLP:AMBER]":
         appCtxt.getCurrentView()._subjectField.value = "[TLP:AMBER] " + subject;
         break;
      case "[TLP:GREEN]":
         appCtxt.getCurrentView()._subjectField.value = "[TLP:GREEN] " + subject;
         break;
      case "[TLP:WHITE]":
